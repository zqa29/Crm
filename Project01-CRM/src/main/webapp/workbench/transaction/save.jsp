...
<body>
	...
	<form action="workbench/transaction/saveTran.do" method="post" id="saveTranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单01">
				<input type="hidden" name="activityId" value="ef85dae43b1d41dba83b32f5f8e50899">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="李旭升">
				<input type="hidden" name="contactsId" value="093820c9d7cb455c95068b69325ba10d">
			</div>
		</div>
