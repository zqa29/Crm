...
<script type="text/javascript">
	...
	$(function(){
		...
		// 为关联市场活动模态窗口中的 搜索框 绑定事件
		$("#searchId").keydown(function (event) {
			if (event.keyCode == 13) {
				$.ajax({
					url:"workbench/clue/getActivityListNotByClueId.do",
					data: {
					...
					success(data){
						...
						$.each(data, function (i,n) {
									html += '<tr>';
									html += '<td><input type="checkbox" name="selectBox" value="'+ n.id +'"/></td>';
									html += '<td>'+ n.name +'</td>';
		...
		$("#boundBtn").click(function () {
			...
			// workbench/clue/boundRelation.do?cId=?&aId=?&aId=?&aId=?
			if ($sb.length != 0) {
				// 判断选择的个数
				// 选择了多少项就有多少个aId
			...
			// ajax
			$.ajax({
				url:"workbench/clue/boundRelation.do?",
				data:param,
				type:"post",
				dataType:"json",
				success(data){
	...
	function unBound(id) {
		// ajax
		$.ajax({
			url:"workbench/clue/deleteRelationById.do",
			data: {
				"id":id
			},
			type:"post",
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" id="searchId" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${clue.fullname}${clue.appellation} </h3>
		</div>
